...
In practice, the app is meant to support cold calling in a fairer and more sustainable way: high enough structure to improve participation, but light enough to use during a live lesson.
